...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles = `relative bg-yellow before:absolute before:w-6 before:h-6 before:border-2 before:border-yellow before:left-[-50%] before:top-[-50%] before:rounded-full`;

  return (
    <div className="flex flex-col gap-6 fixed top-[50%] right-8">
      <AnchorLink
        href="#home"
        className={`${
